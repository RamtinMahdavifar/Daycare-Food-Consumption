...
void main() {
  group("research_group getters and setters", () {
    test("research group getters", () {
      ...
      expect(testResearchGroup.getResearchGroupInfo(),
          ResearchGroupInfo("Test rGroup"));

      testResearchGroup.addNewInstitution(
          InstitutionInfo("test institution", "institution address"));
      ...
      testResearchGroup.addNewInstitution(
          InstitutionInfo("other institution", "other address"));
      expect(testResearchGroup.institutionsMap, <String, InstitutionInfo>{
        "institution address":
            InstitutionInfo("test institution", "institution address"),
  ...
  group("JSON operations", () {
    test("to json", () {
      ...
      expect(testResearchGroup.toJson(), <String, dynamic>{
        "_groupName": "Test rGroup",
        "_groupOwner": jsonEncode(groupOwner),
        "_groupMembers": "[]",
        "_institutionsMap": "{}"
      });
    });
    ...
    test("from json", () {
      ...
      Map<String, dynamic> testJson = <String, dynamic>{
        "_groupName": "Test rGroup",
        "_groupOwner": groupOwner.toJson(),
        "_groupMembers": [],
        "_institutionsMap": <String, InstitutionInfo>{}
      };
