...
void main() {
  group("researcher info operators", () {
    test("toString", () {
      ResearchGroupInfo testResearchGroupInfo =
          ResearchGroupInfo("test research group");
    ...
    test("== operator", () {
      ...
      expect(testResearchGroupInfo == ResearcherInfo("test research group"),
          false);
      ...
      expect(testResearchGroupInfo == ResearchGroupInfo("test research group"),
          true);
  ...
  group("json operations", () {
    test("toJSON", () {
      final ResearchGroupInfo testResearchGroupInfo =
          ResearchGroupInfo("test research group");
      expect(testResearchGroupInfo.toJson(), <String, dynamic>{
        "name": "test research group",
        "databaseKey": "test research group"
      });
    });
    ...
    test("fromJSON", () {
      ...
      expect(ResearchGroupInfo.fromJSON(testJSON),
          ResearchGroupInfo("test research group"));
    });
  });
}
