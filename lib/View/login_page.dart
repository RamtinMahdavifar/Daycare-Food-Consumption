...
class _LoginPageState extends State<LoginPage> {
      ...
      return Padding(
          ...
          child: SizedBox(
              ...
              child: ElevatedButton(
                  ...
                  onPressed: () async {
                    Config.log.i(
                        "user has pressed login button, attempting to login via google");
                    ...
                    await Authentication().googleSignIn().then((result) async {
                      ...
                      Config.log.i(
                          "Authentication finished successfully, navigating to home page...");
                      setState(() {
                      ...
                      Config.log.e(
                          "Error occurred during login, error: ${error.toString()}");
                  ...
                  child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                            ...
                            child: Image.asset("Icons/google-logo-button.png")),
                        Padding(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Center(
            child: ListView(children: <Widget>[appIcon(), loginButton()])));
  }
}
