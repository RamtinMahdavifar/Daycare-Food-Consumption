...
class InputIDForm extends StatefulWidget {
  ...
  InputIDForm(this.currentInstitution, this.currentFoodStatus, {Key? key})
      : super(key: key);
                ...
                Padding(
                  ...
                  child: TextFormField(
                    decoration: InputDecoration(
                        ...
                        errorText: _IdInputEmpty
                            ? "Value Can't Be Empty"
                            : !_IdBelongsToSubject
                                ? "Input ID ${_newIdInputController.value.text} Doesn't Belong To a Subject In This Institution"
                                : null),
              ...
              if (this._IdBelongsToSubject) {
                ...
                Navigator.push(context, MaterialPageRoute(builder: (context) {
                  return CameraFood2(widget.currentInstitution,
                      targetSubjectInfo, widget.currentFoodStatus);
                }));
              } else {
