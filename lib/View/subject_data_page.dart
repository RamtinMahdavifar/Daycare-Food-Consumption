...
class SubjectDataPage extends StatefulWidget {
  ...
  SubjectDataPage(this.currentInstitution, this.currentSubject, {Key? key})
      : super(key: key);
...
class _SubjectDataPageState extends State<SubjectDataPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
            title:
                Text("Data for Subject: ${widget.currentSubject.subjectId}")),
        body: Container(
            child: ListView(
    ...
    return Card(
        ...
        child: Center(
          ...
          children: <Widget>[
            ...
            SizedBox(
              height: 30,
            ), // add sizedBox to separate elements
            OutlinedButton(
                onPressed: () => {},
                style: ButtonStyle(
                    backgroundColor:
